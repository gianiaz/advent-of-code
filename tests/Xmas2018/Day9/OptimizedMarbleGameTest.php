...
use Jean85\AdventOfCode\Xmas2018\Day9\OptimizedMarbleGame;
use PHPUnit\Framework\TestCase;

class OptimizedMarbleGameTest extends TestCase
{
    public function testPlayWithDebug(): void
    {
        $game = new OptimizedMarbleGame(9, 25);
        $game->enableDebug();
        $expectedDebugTrace = [
            '[0] 0<',
            '[1] 0 1<',
            ...
            '[5] 11 1 12 6 13 3 14 7 15 0 16 8 17 4 18 19< 2 20 10 21 5 22',
            '[6] 11 1 12 6 13 3 14 7 15 0 16 8 17 4 18 19 2 24< 20 10 21 5 22',
            '[7] 11 1 12 6 13 3 14 7 15 0 16 8 17 4 18 19 2 24 20 25< 10 21 5 22',
        ];
    ...
    {
        $game = new OptimizedMarbleGame($players, $lastMarble);
